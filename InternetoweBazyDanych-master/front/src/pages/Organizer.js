...
const Organizer = () => {
    return(
      <section className={'profile'}>
          ...
          <a className={'user__button'} href={'organizer/runs'}><p className={'user--text user--button'}>Your runs</p></a>
          <a className={'user__button'} href={'organizer/route'}><p className={'user--text user--button'}>Add Route</p></a>
      </section>
    );
}
